    ...
    <div className={classes.wrapper}>
      <Text as="div">
        ...
        <div className={classes.rsvpFooter}>
          RSVP now by emailing the required deck info to <Link href="mailto:fnm@knoblau.ch">fnm@knoblau.ch</Link>
        </div>
        <div className={classes.rsvpFooter}>
          In case there are more than one, be sure to mention which event you're RSVPing to!
        </div>
      </Text>
